 ...
 *
 * In effect, this prepends the `root to the `relative_path`, then resolves it using the
 * `standardize_path` function. Careful, depending on the relative_path, this could land you above
 * the root, which you don't want for resolving HTTP requests' targets.
 */
